<div class="fixed bottom-4 left-1/2 transform -translate-x-1/2 z-50 
  ...
  <div class="flex justify-between items-center">
    ...
    <!-- Blog -->
    <a href="#" class="cursor-pointer flex flex-col items-center justify-center p-2 group">
      <svg class="w-7 h-7 text-black transition-colors" 
    ...
    <a href="<%=request.getContextPath()%>/profile" class="cursor-pointer flex flex-col items-center justify-center p-2 group">
      ...
      stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> <path d="M12 14C8.13401 14 5 17.134 5 21H19C19 17.134 15.866 14 12 14Z" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
      </path> </g></svg>
