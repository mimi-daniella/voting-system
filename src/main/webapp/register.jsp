           ...
           peer-focus:top-2 peer-focus:text-sm">
					...
					<div id="positionWrapper"
						...
						<p class="mt-2 text-xs text-gray-600">
							Note: If a position already has 3 approved contesters, your contester application will be declined automatically.
						</p>
					</div>
	...
	<script>
		(function () {
			...
			function sync() {
				...
				if (isContester) {
					positionWrapper.classList.remove('max-h-0', 'opacity-0', 'translate-y-[-6px]');
					positionWrapper.classList.add('max-h-40', 'opacity-100', 'translate-y-0', 'mt-2');
					positionSelect.required = true;
				} else {
					positionWrapper.classList.add('max-h-0', 'opacity-0', 'translate-y-[-6px]');
					positionWrapper.classList.remove('max-h-40', 'opacity-100', 'translate-y-0', 'mt-2');
